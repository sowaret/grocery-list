module.exports = Object.freeze({
	err: {
		...
		CONFIRM_PASSWORD_DOESNT_MATCH: { code: 41, message: 'Password and confirm password do not match', status: 400 },
		VALIDATE_USER_LOGIN: { code: 42, message: 'Error validating user login', status: 500 },
		USERNAME_PASSWORD_INCORRECT: { code: 43, message: 'Username or password is incorrect', status: 401 },
		SHEET_PASSWORD_INCORRECT: { code: 44, message: 'Password is incorrect', status: 401 },
		PASSWORD_CANNOT_BE_EMPTY: { code: 45, message: 'Password cannot be empty', status: 409 },
		CHANGE_SHEET_PASSWORD: { code: 46, message: 'Error changing password', status: 500 },
		OLD_PASSWORD_INCORRECT: { code: 47, message: 'Old password is incorrect', status: 401 },
		ADD_USER_TO_SHEET: { code: 48, message: 'Error adding user to sheet', status: 500 },
		UPDATE_LIST_ITEM_CLAIMED_BY: { code: 49, message: 'Error updating list item claimant', status: 500 },
	},
});
