module.exports = Object.freeze({
	err: {
		...
		CREATE_STORE_PRODUCT: {
			code: 17,
			message: 'Error creating store product',
			status: 500,
		},
		...
		KROGER_FIND_STORES: {
			code: 24,
			message: 'Kroger: Error finding stores',
			status: 500,
		},
		KROGER_INVALID_TOKEN: {
			code: 25,
			message: 'Kroger: Invalid token',
			status: 401,
		},
		CHANGE_STORE: { code: 26, message: 'Error changing store', status: 500 },
		KROGER_FIND_PRODUCTS: {
			code: 27,
			message: 'Kroger: Error finding products',
			status: 500,
		},
		PUSH_LIST_ITEM: {
			code: 28,
		...
		FIND_STORE_PRODUCT: {
			code: 29,
			message: 'Error finding store product',
			status: 500,
		},
		INVALID_PARAMETER_IN_CONTROLLER: {
			code: 30,
		...
		FIND_LIST_ITEM: {
			code: 31,
			message: 'Error finding list item',
			status: 500,
		},
		LIST_ITEM_NOT_FOUND: {
			code: 32,
		...
		UPDATE_LIST_ITEM_QUANTITY: {
			code: 33,
			message: 'Error updating list item quantity',
			status: 500,
		},
		UPDATE_SHEET_STORE_PRODUCT_SORT: {
			code: 34,
			message: 'Error updating sheet store product sort',
			status: 500,
		},
		MISMATCH_STORE_PRODUCT: {
			code: 35,
			message: 'Store product in list does not match',
			status: 409,
		},
